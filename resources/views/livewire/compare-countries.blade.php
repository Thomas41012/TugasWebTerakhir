    ...
    public function mount(): void
{
    ...
    */
    ...
    public function updatedSelectedCountries(): void
    {
        ...
        if (auth()->check() && !empty($this->selectedCountries)) {
            $names = Country::whereIn('id', $this->selectedCountries)->pluck('name')->implode(', ');
            \App\Models\UserActivity::create([
                'user_id' => auth()->id(),
                'activity_type' => 'compare_countries',
                'description' => "Compared countries: {$names}.",
